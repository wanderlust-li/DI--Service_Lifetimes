...
using Dl_Service_Lifetime.Models;
using Dl_Service_Lifetime.Services;

namespace Dl_Service_Lifetime.Controllers;
...
public class HomeController : Controller
{
    ...
    public HomeController(IScopedGuidService scopedGuid1,
        IScopedGuidService scopedGuid2, ISingletonGuidService singletonGuid1,
        ISingletonGuidService singletonGuid2, ITransientGuidService transientGuid1,
